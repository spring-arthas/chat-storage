...
public struct UserDto: Codable, Identifiable {
    ...
    public let friendStatus: Int? // 0=等待同意, 1=好友, 2=可重新申请, 3=可添加, 4=对方已申请, 5=自己
    public let friendStatusDesc: String?
    public let incomingRequestId: Int64?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.incomingRequestId = try container.decodeIfPresent(Int64.self, forKey: .incomingRequestId)
    }
}
