...
#ifndef CHAT_STORAGE_SWIFT_H
#define CHAT_STORAGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="chat_storage",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Item (SWIFT_EXTENSION(chat_storage))
